...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set adc_clock_out [ create_bd_port -dir O adc_clock_out ]
  set cs [ create_bd_port -dir O cs ]
  set data_ready_test [ create_bd_port -dir O data_ready_test ]
  set signal_in [ create_bd_port -dir I signal_in ]
  ...
  connect_bd_intf_net -intf_net axi_gpio_2_GPIO [get_bd_intf_ports gpio_rtl_0] [get_bd_intf_pins axi_gpio_2/GPIO]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins axi_lite_slave_0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  ...
  connect_bd_net -net adc_0_adc_clock_out [get_bd_ports adc_clock_out] [get_bd_pins adc_0/adc_clock_out]
  connect_bd_net -net adc_0_cs [get_bd_ports cs] [get_bd_pins adc_0/cs]
  connect_bd_net -net adc_0_data [get_bd_pins adc_0/data] [get_bd_pins axi_lite_slave_0/data]
  connect_bd_net -net adc_0_data_ready [get_bd_pins adc_0/data_ready] [get_bd_pins axi_lite_slave_0/data_ready]
  connect_bd_net -net adc_0_data_ready_test [get_bd_ports data_ready_test] [get_bd_pins adc_0/data_ready_test]
  connect_bd_net -net axi_gpio_1_ip2intc_irpt [get_bd_pins axi_gpio_1/ip2intc_irpt] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net axi_lite_slave_0_interrupt [get_bd_pins adc_0/recieve_ready] [get_bd_pins axi_gpio_1/gpio_io_i] [get_bd_pins axi_lite_slave_0/interrupt]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins adc_0/h_clock] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_lite_slave_0/S_AXI_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins adc_0/adc_clock] [get_bd_pins processing_system7_0/FCLK_CLK1]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins adc_0/resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_lite_slave_0/S_AXI_ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net signal_in_1 [get_bd_ports signal_in] [get_bd_pins adc_0/signal_in]
